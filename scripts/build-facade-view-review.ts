...
const manifest = JSON.parse(await readFile(path.join(root, 'wide-crop-manifest.json'), 'utf8')) as {
  crops: Crop[];
  generatedAt?: string;
  mission?: string;
  policy?: unknown;
